...
function PopupMessageSOL(frame = null) {
  ...
  Object.defineProperty(this, 'frame', {
    get: () => { return _args.information.frame },
    set: (value) => { _args.information.frame = value }
  })
}
...
function _closeConfirmDialogs(counting = 1) {
  ...
  try {
    ...
    if (counting < 2) {
      ...
      await _closeConfirmDialogs(counting + 1)
    }
  } catch (e) {
...
function _closeCommuniqueDialogs() {
